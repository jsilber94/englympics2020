...
class MatchString:
    ...
    def __init__(self):
        ...
        self.insert_costs[ord(' ')] = 0.25
        self.insert_costs[ord('1')] = 0.5
        self.insert_costs[ord('2')] = 0.5
        self.insert_costs[ord('3')] = 0.5
        self.insert_costs[ord('4')] = 0.5
        self.insert_costs[ord('5')] = 0.5
        self.insert_costs[ord('6')] = 0.5
        self.insert_costs[ord('7')] = 0.5
        self.insert_costs[ord('8')] = 0.5
        self.insert_costs[ord('9')] = 0.5
